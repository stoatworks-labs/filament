/*
 * Stoatworks Labs - About window data for Filament.
 *
 ...
 * --only filament --apply` overwrites this with the generated copy. The facts
...
{
    inline constexpr auto name = "Filament";
    inline constexpr auto slug = "filament";
    inline constexpr auto hook = "A wall of tungsten bulbs, for Resolume";
