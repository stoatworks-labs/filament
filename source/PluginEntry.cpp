/**
	...
	`CFFGLPluginInfo` that Filament.cpp registers at static-initialisation
	...
	binary: which build it is.
		...
		strings Filament.bundle/Contents/MacOS/Filament | grep filament
*/

extern "C" const char* FilamentBuildStamp()
{
	return "filament " FILAMENT_VERSION " built " __DATE__ " " __TIME__;
}
